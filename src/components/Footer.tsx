      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-secondary">ARCHITECTURE</span>
            </div>
            <p className="text-secondary max-w-xs">
              Form, fonksiyon ve sürdürülebilirliği harmanlayan yenilikçi mimari çözümler yaratıyoruz.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#design-implementation" className="text-secondary hover:text-primary transition-colors">
                  Tasarım Uygulama
                </Link>
              </li>
              <li>
                <Link href="/#licensing" className="text-secondary hover:text-primary transition-colors">
                  Lisanslama
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-secondary">Mimari Tasarım</li>
              <li className="text-secondary">İç Mekan Tasarımı</li>
              <li className="text-secondary">Şehir Planlama</li>
              <li className="text-secondary">Sürdürülebilir Çözümler</li>
              <li className="text-secondary">3D Görselleştirme</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-secondary">123 Architecture Street</li>
              <li className="text-secondary">Design District, City</li>
              <li className="text-secondary">info@kenet-architecture.com</li>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-secondary text-sm">
            © {currentYear} Kenet Mimarlık. Tüm hakları saklıdır.
          </p>
